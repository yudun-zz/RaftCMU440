...
*
*	DESCRIPTION:
*			Signatures for the RPC in raft proxy
 */
...
type RemoteRaftNode interface {
	...
	// used for test, check if a list of behavior is expected
	CheckEvents(args *CheckEventsArgs, reply *CheckEventsReply) error
}
